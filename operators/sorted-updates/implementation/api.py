...
CORS_ORIGINS = os.getenv(
    ...
    "https://graciebarrahalesowen.com,https://www.graciebarrahalesowen.com,https://sortmydigital.netlify.app,https://gbhalesowen.netlify.app,http://localhost:3000,http://localhost:3001",
)
