    ...
    <V2Page>
      <div className="grid lg:grid-cols-[220px_1fr]">
        <aside className="hidden border-r border-black/10 px-7 py-8 lg:block">
          <a href="/ops" className="inline-flex min-h-11 items-center text-[33px] font-black leading-none tracking-[-0.045em] sm:text-[40px]">Sorted<span className="text-[#cfe900]">.</span><span className="[font-family:var(--font-v2-bakeshop)] translate-y-[-0.06em] text-[#cfe900]">ops</span></a>
