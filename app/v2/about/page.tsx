...
const beliefs = [
  ["Every business accumulates operational drag.", "It is a natural consequence of growth. More customers, more systems and more people create more manual routines.", Layers3],
  ["Operational constraints decide performance.", "Every weak system takes attention away from customers, improvement and growth.", Clock3],
    ...
    <V2Page>
      ...
      <section className="mx-auto grid max-w-[1220px] gap-10 px-5 pb-10 pt-12 sm:px-8 lg:grid-cols-[0.9fr_1fr_1.1fr] lg:items-start">
        ...
        <div className="text-[17px] font-semibold leading-[1.65] tracking-[-0.035em]">
          ...
          <p className="mt-8">Sorted finds the constraint, installs the system that removes it, and gives businesses the capacity to focus on the <strong>work only people can do.</strong></p>
        </div>
        ...
        <div className="relative overflow-hidden rounded-[22px] bg-[#070707] p-8 text-white shadow-[0_22px_55px_rgba(0,0,0,0.18)]">
          ...
          <div className="relative">
            ...
            <p className="mt-14 max-w-[320px] text-[28px] font-black uppercase leading-[1.18] tracking-[-0.04em]">
              We install systems that remove repetitive work so businesses can focus on what matters.
            </p>
      ...
      <section className="mx-auto grid max-w-[1220px] gap-5 px-5 py-8 sm:px-8 lg:grid-cols-[0.7fr_0.62fr_1.15fr]">
        ...
        <article className="relative overflow-hidden rounded-[18px] border border-black/10 bg-white p-8">
          ...
          <p className="mt-8 max-w-[460px] text-[14px] font-semibold leading-[1.7]">
            Sorted helps businesses perform better. We do not sell automation for the sake of automation. We do not build systems because technology is interesting.
          </p>
      ...
      <CtaBand title="Every business has a constraint like this." copy="Start with a diagnostic and we will help you identify the first system worth installing." />
      <V2Footer />
    </V2Page>
  )
}
