...
export default function ReviewPage() {
  ...
  useEffect(() => {
    // Client ad review moved to /ad-review/. Redirect legacy links
    // (/review/?tenant=...&campaign=... or /review/?t=...) so they keep working.
    const params = new URLSearchParams(window.location.search)
    if (params.has("tenant") || params.has("campaign") || params.has("t")) {
      window.location.replace(`/ad-review/${window.location.search}`)
      return
    }
