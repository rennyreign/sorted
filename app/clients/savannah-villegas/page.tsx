...
export default function SavannahQuote() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault()
    if (password.toLowerCase() === "savannah2026") {
      setIsAuthenticated(true)
      setError(false)
      saveAuth()
    } else {
    ...
    return (
      <main className="min-h-screen flex items-center justify-center px-6">
        <div className="max-w-sm w-full">
          ...
          <h1 className="font-sans font-bold text-[#0A0A0A] text-xl mb-2">Private — For Savannah</h1>
    ...
    <>
      <main className="max-w-[680px] mx-auto px-6 sm:px-10 pt-24 pb-32">
        ...
        <div className="mb-16">
          ...
          <p className="font-mono text-xs text-[#A3A3A3] uppercase tracking-[0.15em]">Private — for Savannah Villegas</p>
        </div>
        ...
        <p className="font-mono text-xs uppercase tracking-[0.15em] text-[#A3A3A3] mb-10">Savannah Villegas — Site Delivery</p>
            ...
            {[
              {
                ...
                body: "A fully designed and built website at savannahvillegas.com. Seven pages — Home, About, Work, Services, Process, Updates, and Contact. Optimised for mobile and desktop. Built for social-first video production.",
              },
              {
                num: "02",
                title: "SortedUpdates CMS",
                body: "A private content management system at your site URL /cms. Every piece of text and every image on the site is editable without touching any code. Changes go live automatically after you hit Publish.",
              },
              {
                num: "03",
              ...
              {
                num: "04",
                title: "Up to 8 Portfolio Videos",
                body: "Four work items visible on your homepage. Up to eight total in your Work archive. Add new videos at any time through the CMS — no Sorted involvement needed.",
              },
              {
                num: "05",
                title: "Netlify Hosting",
                body: "Your site is hosted on Netlify with continuous deployment. Every time you publish a change, the site rebuilds and goes live automatically. No FTP. No technical knowledge required.",
              },
            ].map((item) => (
        ...
        <div className="mb-16">
          ...
          {/* Wise Payment — QR code in public/qrcode-savannah.png */}
          <div className="p-6 bg-[#F5F5F5] rounded-xl border border-black/[0.06] mb-6">
            ...
            <div className="flex flex-col sm:flex-row gap-6 items-start">
              <img
                src="/qrcode-savannah.png?v=2"
                alt="Wise QR code for payment"
                className="w-40 h-auto rounded-lg bg-white p-2 shadow-sm"
              />
        ...
        <div className="mb-16">
          ...
          <ul className="space-y-2 text-[#737373] text-base leading-relaxed">
            {[
              ...
              "Add new work videos (up to 8 total)",
              "Update your services, process steps, and FAQs",
        ...
        <div className="space-y-6 text-[#525252] text-lg leading-relaxed mb-16">
          <p>
            The site is yours to run. The CMS is your control panel. Everything you need to keep your content fresh and your portfolio current is already there.
          </p>
          <p className="text-[#0A0A0A] font-semibold">
