...
const initialChecklist: ChecklistItem[] = [
  // Alignment & Payment
  { id: "1", stage: "Kickoff", task: "Alignment meeting", status: "completed", date: "Tue, May 19" },
  { id: "2", stage: "Kickoff", task: "Initial payment: $2000", status: "pending", date: "Wed, May 20" },
  
  // Platform Setups - Wed, May 20 - Thu, May 21
  { id: "3", stage: "Platform Setup", task: "Facebook page setup", status: "completed", date: "Wed, May 20" },
  { id: "4", stage: "Platform Setup", task: "New Instagram account", status: "pending", date: "Wed, May 27" },
  { id: "5", stage: "Platform Setup", task: "YouTube / Google account invite for renaldo", status: "completed", date: "Wed, May 20" },
  { id: "6", stage: "Platform Setup", task: "New Spotify for Artists account", status: "pending", date: "Wed, May 27" },
  { id: "7", stage: "Platform Setup", task: "New Apple Music for Artists account", status: "pending", date: "Wed, May 27" },
  { id: "8", stage: "Platform Setup", task: "Content Drive setup & shared access", status: "completed", date: "Fri, May 22" },
  
  // Building Work - Mon, May 25 - Fri, May 29
  { id: "9", stage: "Build", task: "Video content guidance and strategic plan", status: "completed", date: "Fri, May 22" },
  { id: "10", stage: "Build", task: "Website build complete", status: "pending", date: "Wed, May 27" },
  { id: "11", stage: "Build", task: "Facebook branding", status: "completed", date: "Fri, May 22" },
  { id: "12", stage: "Build", task: "Instagram branding", status: "pending", date: "Thu, May 28" },
  { id: "13", stage: "Build", task: "YouTube branding", status: "pending", date: "Thu, May 28" },
  { id: "14", stage: "Build", task: "TikTok branding", status: "pending", date: "Thu, May 28" },
  { id: "15", stage: "Build", task: "Video overlay branding", status: "pending", date: "Fri, May 29" },
  { id: "16", stage: "Build", task: "Song cover branding", status: "pending", date: "Fri, May 29" },
  { id: "17", stage: "Build", task: "Analytics dashboard setup", status: "pending", date: "Mon, Jun 1" },
]

const stageColors: Record<string, string> = {
  "Kickoff": "bg-blue-500/10 text-blue-600",
  "Platform Setup": "bg-purple-500/10 text-purple-600",
    ...
    return (
      <main className="min-h-screen flex items-center justify-center px-6">
        <div className="max-w-sm w-full">
          ...
          <p className="text-[#737373] text-sm mb-6">Enter the password to view the project timeline.</p>
    ...
    <main className="max-w-[720px] mx-auto px-6 sm:px-10 pt-16 pb-24">
      ...
      <div className="mb-10">
        <div className="flex items-center gap-3 mb-4">
          ...
          <a href="/clients/roye-abramson" className="text-[#737373] text-sm hover:text-[#0A0A0A] transition-colors">Agreement</a>
        </div>
        ...
        <p className="text-[#737373] text-base">
          Track progress from alignment through to launch.
        </p>
      </div>
                ...
                {stageItems.map(item => (
                  ...
                  >
                    ...
                    <div className="flex-1">
                      ...
                      {item.date && (
                        <span className="text-xs text-[#A3A3A3] mt-1 block">{item.date}</span>
                      )}
                    </div>
                    
                    {/* Status label */}
                    <span className={`shrink-0 text-[10px] uppercase tracking-[0.1em] font-medium ${
                      item.status === "completed"
                        ? "text-green-600"
                        : item.status === "in-progress"
                        ? "text-[#0A0A0A]"
