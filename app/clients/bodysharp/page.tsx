...
const SIGN_SLUG = "bodysharp"
const DOC_TYPE = "delivery"
const PAGE_PATH = "/clients/bodysharp"
const CLIENT_NAME = "BodySharp"
...
export default function BodysharpRetainer() {
  ...
  const [signedAt, setSignedAt] = useState<string | null>("2026-06-02T00:00:00.000Z")
