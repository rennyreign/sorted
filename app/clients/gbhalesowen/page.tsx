...
const AUTH_KEY = "gbhalesowen_auth"
  ...
  return (
    <div className="min-h-screen bg-[#0f0f0f] text-white">
      ...
      <footer className="border-t border-white/8 px-5 py-8 text-center">
        <p className="text-xs text-white/25">Sorted · <a href="https://sortmydigital.site" className="hover:text-white/50">sortmydigital.site</a></p>
      </footer>
