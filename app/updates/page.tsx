...
import { Send, Paperclip, Clock, CheckCircle, AlertCircle, Loader2 } from "lucide-react"
...
export default function UpdatesPortalPage() {
  const [messages, setMessages] = useState<Message[]>([
    {
      id: "welcome",
      role: "assistant",
      content: "Hi! I'm your Sorted Updates agent. What would you like to change on your site?",
    },
  ])
  ...
  const handleSend = async () => {
    ...
    setTimeout(() => {
      const isSafeChange = input.length < 100 && !input.includes("pricing") && !input.includes("legal")
        ...
        setTimeout(() => {
          setMessages(prev => [
            ...prev,
            {
              ...
              role: "assistant",
              content: "Done: https://gbhalesowen.site",
              status: "sent",
            },
          ])
        }, 3000)
      ...
      <header className="bg-white border-b border-black/[0.06] px-6 py-4">
        <div className="max-w-2xl mx-auto flex items-center justify-between">
          <div>
            ...
            <p className="text-[#525252] text-xs">Gracie Barra Halesowen</p>
          </div>
