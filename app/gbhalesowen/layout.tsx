      ...
      <footer className="bg-[#002766] text-white">
        <div className="mx-auto grid max-w-[1400px] gap-10 px-5 py-10 sm:px-8 md:grid-cols-[1.2fr_1fr_1fr_1fr] lg:px-12">
          ...
          <div>
            ...
            <div className="mt-4 grid gap-2 text-sm font-semibold text-white/78">
              <Link href="programs/fundamentals" className="transition-colors hover:text-white">Fundamentals</Link>
              <Link href="programs/advanced" className="transition-colors hover:text-white">Advanced</Link>
              <Link href="programs/kids" className="transition-colors hover:text-white">Kids Classes</Link>
              <Link href="programs/female" className="transition-colors hover:text-white">Female Training</Link>
              <Link href="programs/fitness" className="transition-colors hover:text-white">Barbell / Fitness</Link>
            </div>
          </div>
          <div>
