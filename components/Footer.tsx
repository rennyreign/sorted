      ...
      <div className="max-w-[1400px] mx-auto">
        ...
        <div className="border-t border-white/[0.08] pt-8 flex flex-col sm:flex-row justify-between gap-4 items-start sm:items-center">
          ...
          <div className="flex items-center gap-6">
            ...
            <a href="https://wa.me/447386468085" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp Sorted" className="inline-flex items-center gap-1.5 text-xs text-[#525252] hover:text-[#A3A3A3] transition-colors font-medium">
