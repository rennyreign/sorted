...
- Auth path hardened: layout token redirect (`afterInteractive`), widget iframe above overlay, token hashes stripped only after completed/closed widget flow — see `doctrine/sorted-studio-cms.md` "Auth path requirements"
