...
const links = [
  ...
  // Add more links as needed for this client
]
    ...
    <>
      <header className="sticky top-0 inset-x-0 z-50 px-6 sm:px-10 lg:px-16 pt-5 flex items-center justify-between bg-white/80 backdrop-blur-md pointer-events-none">
        ...
        <nav className="pointer-events-auto hidden md:flex items-center gap-5 rounded-full bg-white/90 backdrop-blur-md border border-black/[0.08] shadow-[0_2px_20px_rgba(0,0,0,0.06)] px-5 py-2.5">
          ...
          {/* Optional: WhatsApp icon - customize per client */}
          <a href="https://wa.me/" target="_blank" rel="noopener noreferrer" aria-label="Chat on WhatsApp" className="text-[#25D366] hover:opacity-80 transition-opacity duration-200">
          ...
          <a href="#contact" className="text-xs font-semibold text-[#FAFAFA] bg-[#0A0A0A] rounded-full px-4 py-2 hover:bg-[#2a2a2a] transition-colors duration-200">
            Get in touch
          </a>
        </nav>
        ...
        <div className="pointer-events-auto flex md:hidden items-center gap-2.5">
          <a href="#contact" onClick={() => setOpen(false)} className="text-xs font-semibold text-[#FAFAFA] bg-[#0A0A0A] rounded-full px-4 py-2">
            Contact
          </a>
          <button
            type="button"
